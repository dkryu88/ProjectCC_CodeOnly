...
#include "PlayerConditionEffect_Electronic.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTCC_API UPlayerConditionEffect_Electronic : public UPlayerConditionEffect
{
	GENERATED_BODY()
...
public:
	...
	virtual void ResumeEffectVisual(APlayer_Character* Player, UPlayerConditionComponent* ConditionComp, FPlayerCondition& ConditionData) override;
};
